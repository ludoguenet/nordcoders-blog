...
class Post extends \AppBundle\Entity\Post implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Post' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Post' . "\0" . 'title', '' . "\0" . 'AppBundle\\Entity\\Post' . "\0" . 'content', '' . "\0" . 'AppBundle\\Entity\\Post' . "\0" . 'createdAt', '' . "\0" . 'AppBundle\\Entity\\Post' . "\0" . 'author', '' . "\0" . 'AppBundle\\Entity\\Post' . "\0" . 'isPublished', '' . "\0" . 'AppBundle\\Entity\\Post' . "\0" . 'tags'];
        }
