...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array(), $containerDir = __DIR__)
    {
        ...
        $this->normalizedIds = array(
            ...
            'appbundle\\form\\avatartype' => 'AppBundle\\Form\\AvatarType',
            'appbundle\\form\\imagetype' => 'AppBundle\\Form\\ImageType',
            'appbundle\\form\\posttype' => 'AppBundle\\Form\\PostType',
            'appbundle\\form\\useredittype' => 'AppBundle\\Form\\UserEditType',
            'appbundle\\form\\userpasswordedittype' => 'AppBundle\\Form\\UserPasswordEditType',
            'appbundle\\form\\usertype' => 'AppBundle\\Form\\UserType',
            'appbundle\\security\\commentvoter' => 'AppBundle\\Security\\CommentVoter',
        ...
        $this->fileMap = array(
            ...
            'AppBundle\\Form\\AvatarType' => 'getAvatarTypeService.php',
            'AppBundle\\Form\\ImageType' => 'getImageTypeService.php',
            'AppBundle\\Form\\PostType' => 'getPostTypeService.php',
            'AppBundle\\Form\\UserEditType' => 'getUserEditTypeService.php',
            'AppBundle\\Form\\UserPasswordEditType' => 'getUserPasswordEditTypeService.php',
            'AppBundle\\Form\\UserType' => 'getUserTypeService.php',
            'AppBundle\\Security\\CommentVoter' => 'getCommentVoterService.php',
            ...
            'app.form.type.tags' => 'getApp_Form_Type_TagsService.php',
            ...
            'security.user.provider.concrete.my_provider' => 'getSecurity_User_Provider_Concrete_MyProviderService.php',
            ...
            'service_locator.npwnorr' => 'getServiceLocator_NpwnorrService.php',
        ...
        $this->privates = array(
            ...
            'AppBundle\\Form\\AvatarType' => true,
            'AppBundle\\Form\\ImageType' => true,
            'AppBundle\\Form\\PostType' => true,
            'AppBundle\\Form\\UserEditType' => true,
            'AppBundle\\Form\\UserPasswordEditType' => true,
            'AppBundle\\Form\\UserType' => true,
            'AppBundle\\Security\\CommentVoter' => true,
            'annotation_reader' => true,
            'annotations.cache' => true,
            'annotations.cache_warmer' => true,
            'annotations.reader' => true,
            'app.form.type.tags' => true,
        ...
        $this->privates['service_container'] = function () {
            ...
            include_once $this->targetDirs[3].'/src/AppBundle/Twig/AppExtension.php';
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('WjxKHoaM5M', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Kag6dF2R5m', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('j9dReVFDFp', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('9u9FshFIYB', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('0LW1kn6MP0', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getDebug_Security_Access_DecisionManagerService()
    {
        return $this->services['debug.security.access.decision_manager'] = new \Symfony\Component\Security\Core\Authorization\TraceableAccessDecisionManager(new \Symfony\Component\Security\Core\Authorization\AccessDecisionManager(new RewindableGenerator(function () {
            ...
            yield 3 => ${($_ = isset($this->services['AppBundle\Security\CommentVoter']) ? $this->services['AppBundle\Security\CommentVoter'] : $this->load('getCommentVoterService.php')) && false ?: '_'};
    ...
    {
        return $this->services['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(${($_ = isset($this->services['uri_signer']) ? $this->services['uri_signer'] : $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('6d2af8e5f8a0ae0d8573941a99e32072bc69eade')) && false ?: '_'}, '/_fragment');
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('6d2af8e5f8a0ae0d8573941a99e32072bc69eade');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => '6d2af8e5f8a0ae0d8573941a99e32072bc69eade',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => '',
            'fragment.path' => '/_fragment',
            'kernel.secret' => '6d2af8e5f8a0ae0d8573941a99e32072bc69eade',
