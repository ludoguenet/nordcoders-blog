...
}, 'fos_ck_editor.command.installer' => function () {
    $f = function (\FOS\CKEditorBundle\Command\CKEditorInstallerCommand $v) { return $v; }; return $f(${($_ = isset($this->services['fos_ck_editor.command.installer']) ? $this->services['fos_ck_editor.command.installer'] : $this->load('getFosCkEditor_Command_InstallerService.php')) && false ?: '_'});
