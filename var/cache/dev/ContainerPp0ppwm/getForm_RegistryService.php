...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('AppBundle\\Form\\AvatarType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\AvatarType']) ? $this->services['AppBundle\Form\AvatarType'] : $this->services['AppBundle\Form\AvatarType'] = new \AppBundle\Form\AvatarType()) && false ?: '_'};
    ...
    return ${($_ = isset($this->services['AppBundle\Form\PostType']) ? $this->services['AppBundle\Form\PostType'] : $this->services['AppBundle\Form\PostType'] = new \AppBundle\Form\PostType()) && false ?: '_'};
}, 'AppBundle\\Form\\TagType' => function () {
    return ${($_ = isset($this->services['app.form.type.tags']) ? $this->services['app.form.type.tags'] : $this->load('getApp_Form_Type_TagsService.php')) && false ?: '_'};
}, 'AppBundle\\Form\\UserEditType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\UserEditType']) ? $this->services['AppBundle\Form\UserEditType'] : $this->services['AppBundle\Form\UserEditType'] = new \AppBundle\Form\UserEditType()) && false ?: '_'};
}, 'AppBundle\\Form\\UserPasswordEditType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\UserPasswordEditType']) ? $this->services['AppBundle\Form\UserPasswordEditType'] : $this->services['AppBundle\Form\UserPasswordEditType'] = new \AppBundle\Form\UserPasswordEditType()) && false ?: '_'};
