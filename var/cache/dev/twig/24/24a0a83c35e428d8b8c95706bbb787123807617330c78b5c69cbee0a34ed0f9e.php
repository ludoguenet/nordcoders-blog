...
class __TwigTemplate_3e25ba7f75e097204950aee57e58c4f5b0e4390e74d81f3c1746b8eb89a9248a extends Twig_Template
{
    private $source;
    ...
    ";
        // line 10
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new Twig_Error_Runtime('Variable "form" does not exist.', 10, $this->source); })()), "avatar", array()), 'row', array("attr" => array("class" => "input")));
        echo "
    ";
        // line 11
...
";
    ...
    {
        return array (  98 => 11,  94 => 10,  90 => 9,  85 => 8,  79 => 6,  77 => 5,  74 => 4,  65 => 3,  45 => 2,  15 => 1,);
    }
...
{% block body %}
    ...
    {% if (app.user.avatar != null) %}
        <img width=\"25%\" src=\"{{ asset('uploads/avatar/') ~ app.user.avatar }}\" alt=\"avatar\">
    {% endif %}
    {{ form_start(form) }}
    {{ form_errors(form.avatar) }}
    {{ form_row(form.avatar, {'attr': {'class' : 'input'}}) }}
    {{ form_end(form) }}
