...
class Image extends \AppBundle\Entity\Image implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Image' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Image' . "\0" . 'extension', '' . "\0" . 'AppBundle\\Entity\\Image' . "\0" . 'alt', '' . "\0" . 'AppBundle\\Entity\\Image' . "\0" . 'file', '' . "\0" . 'AppBundle\\Entity\\Image' . "\0" . 'tempFileName'];
        }
